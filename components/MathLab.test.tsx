...
describe("MathLab", () => {
  ...
  it("resets one selected course without changing the others", () => {
    ...
    expect(screen.getByText("已完成 1/65 课")).toBeInTheDocument();
  ...
  it("keeps reset all as a separate confirmed action", () => {
    ...
    expect(screen.getByText("已完成 0/65 课")).toBeInTheDocument();
