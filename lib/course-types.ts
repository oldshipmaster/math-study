...
export type LessonScene = {
  id: string;
  kind: "count" | "story" | "match" | "place" | "build" | "sequence" | "visual-pattern" | "number-line" | "compare" | "order" | "estimate" | "rounding" | "multiples" | "prime" | "factor-tree" | "power" | "fraction" | "fraction-operation" | "decimal" | "ratio" | "addition" | "subtraction" | "quiz";
  eyebrow: string;
  title: string;
  body: string;
  instruction?: string;
